    ...
    'navSections' => [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Programas educativos', 'href' => 'programas_admin.php', 'icon' => 'school', 'match' => ['programas_admin.php', 'programas_edit.php']],
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Categoría productos', 'href' => 'categorias_productos.php', 'icon' => 'category', 'match' => ['categorias_productos.php']],
