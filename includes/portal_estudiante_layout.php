...
function portalEstudianteCabecera(string $titulo, string $activo = 'inicio', string $descripcion = '', bool $permitirIncompleto = false): array
{
    ...
    $notificacionesPortal = notificacionesUsuarioResumen((int)$perfil['id'],1);
...
<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all">
  ...
  <div class="sidebar-body pt-0 data-scrollbar"><div class="sidebar-list"><ul class="navbar-nav iq-main-menu" id="sidebar-menu">
    ...
    <li class="nav-item"><a class="<?= $enlace('carrito','') ?>" href="<?= atenea_url('src/carrito/index.php') ?>"><i class="icon"><i class="bi bi-cart3"></i></i><span class="item-name">Mi carrito</span><?php if($cantidadCarrito):?><span class="badge bg-danger ms-auto"><?=$cantidadCarrito?></span><?php endif;?></a></li>
    ...
    <li class="nav-item"><a class="<?= $enlace('notificaciones','') ?>" href="<?=atenea_url('src/notificaciones/index.php')?>"><i class="icon"><i class="bi bi-bell"></i></i><span class="item-name">Notificaciones</span><span class="badge bg-danger ms-auto" data-atenea-notification-count <?=$notificacionesPortal['no_leidas']?'':'hidden'?>><?=(int)$notificacionesPortal['no_leidas']?></span></a></li>
