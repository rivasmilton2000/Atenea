var cities = {
	...
	'Chalatenango': [
	  ...
	  'La Laguna', 'La Palma', 'La Reina', 'Las Flores', 'Las Vueltas',
	  ...
	  'San Ignacio', 'San Isidro Labrador', 'San Luis del Carmen', 'San Miguel de Mercedes', 'San Rafael',
	  'Santa Rita', 'Tejutla'
	],
	'Cuscatlán': [
	...
	'La Paz': [
	  ...
	  'Paraíso de Osorio', 'San Antonio Masahuat', 'San Emigdio', 'San Francisco Chinameca', 'San Juan Nonualco',
	  'San Juan Talpa', 'San Juan Tepezontes', 'San Luis La Herradura', 'San Luis Talpa', 'San Miguel Tepezontes',
	  'San Pedro Masahuat', 'San Pedro Nonualco', 'San Rafael Obrajuelo', 'Santa María Ostuma', 'Santiago Nonualco',
	...
	'San Miguel': [
	  ...
	  'Nuevo Edén de San Juan', 'Quelepa', 'San Antonio del Mosco', 'San Gerardo', 'San Jorge',
	...
	'San Salvador': [
	  ...
	  'Panchimalco', 'Rosario de Mora', 'San Marcos', 'San Martín', 'San Salvador',
	...
	'Sonsonate': [
	  ...
	  'San Julián', 'Santa Catarina Masahuat', 'Santa Isabel Ishuatán', 'Santo Domingo de Guzmán', 'Sonsonate',
	  'Sonzacate'
	],
	'Usulután': [
	  'Alegría', 'Berlín', 'California', 'Concepción Batres', 'El Triunfo',
	  'Ereguayquín', 'Estanzuelas', 'Jiquilisco', 'Jucuapa', 'Jucuarán',
	  'Mercedes Umaña', 'Nueva Granada', 'Ozatlán', 'Puerto El Triunfo', 'San Agustín',
	  'San Buenaventura', 'San Dionisio', 'San Francisco Javier', 'Santa Elena', 'Santa María',
  ...
  var City = function() {
	...
	this.getCities = function(province) {
	  if(province.length==0) {
		console.error('Por favor ingrese el nombre del departamento');
		return;
	  }
	...
	this.showProvinces = function(element) {
	  var str = '<option selected disabled>Seleccionar Departamento</option>';
	...
	this.showCities = function(province,element) {
	  var str = '<option selected disabled>Seleccionar Municipio</option>';
	  var elem = '';
