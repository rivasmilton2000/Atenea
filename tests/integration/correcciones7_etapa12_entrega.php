...
try{
  ...
  $assert(str_contains((string)file_get_contents($root.'/src/dashboard/_auth_guard.php'),'exigirRol')&&str_contains((string)file_get_contents($root.'/src/dashboard/includes/cms.php'),'/_auth_guard.php'),'El dashboard administrativo exige un rol autorizado mediante el guard central');
