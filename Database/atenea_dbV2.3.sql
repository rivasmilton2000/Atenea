...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2026 a las 04:07:39
...
--
-- Estructura de tabla para la tabla `academic_charges`
--

CREATE TABLE `academic_charges` (
  `id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `cycle_id` int(11) NOT NULL,
  `plan_id` int(11) DEFAULT NULL,
  `charge_type` enum('enrollment','monthly','other') NOT NULL,
...
--
-- Volcado de datos para la tabla `academic_charges`
--

INSERT INTO `academic_charges` (`id`, `student_id`, `cycle_id`, `plan_id`, `charge_type`, `period_label`, `description`, `amount`, `discount_amount`, `penalty_amount`, `paid_amount`, `due_date`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 6, 1, NULL, 'enrollment', 'Julio 2026', 'Mensualidad de Julio', 125.00, 0.00, 25.00, 150.00, '2026-07-05', 'paid', 14, '2026-07-04 01:09:06', '2026-07-04 01:09:14'),
(2, 6, 1, NULL, 'monthly', 'Julio 2026', 'Mensualidad de Julio', 125.00, 0.00, 25.00, 0.00, '2026-07-07', 'pending', 14, '2026-07-04 01:10:24', '2026-07-04 01:10:24');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `academic_cycles`
--
...
--
-- Volcado de datos para la tabla `academic_cycles`
--

INSERT INTO `academic_cycles` (`id`, `name`, `starts_on`, `ends_on`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'Ciclo 2026', '2026-01-01', '2026-12-31', 1, '2026-07-03 21:30:00', '2026-07-03 21:30:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `academic_dte_documents`
--

CREATE TABLE `academic_dte_documents` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `academic_payments`
--

CREATE TABLE `academic_payments` (
  `id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `cycle_id` int(11) NOT NULL,
  `user_id` int(11) DEFAULT NULL,
  ...
  `payment_method` enum('stripe','cash','bank','other') NOT NULL DEFAULT 'stripe',
  `amount` decimal(10,2) NOT NULL,
...
--
-- Volcado de datos para la tabla `academic_payments`
--

INSERT INTO `academic_payments` (`id`, `student_id`, `cycle_id`, `user_id`, `stripe_session_id`, `stripe_payment_intent`, `payment_method`, `amount`, `status`, `payer_name`, `payer_email`, `notes`, `paid_at`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 6, 1, NULL, NULL, NULL, 'cash', 150.00, 'paid', 'Jose Alejandro Martinez Hernandez', 'jose.martinez@gmail.com', NULL, '2026-07-03 19:09:14', 14, '2026-07-04 01:09:14', '2026-07-04 01:09:14'),
(2, 6, 1, 26, 'cs_test_a1KuzSsay8hxvsIhtjusq3sUb9wJvcAqLxlDia3tttGfDwO3hahzd2ByuX', NULL, 'stripe', 150.00, 'pending_payment', 'Jose Alejandro Martinez Hernandez', 'jose.martinez@gmail.com', NULL, NULL, NULL, '2026-07-04 01:11:15', '2026-07-04 01:11:17');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `academic_payment_details`
--

CREATE TABLE `academic_payment_details` (
  `id` int(11) NOT NULL,
  `payment_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `academic_payment_details`
--

INSERT INTO `academic_payment_details` (`id`, `payment_id`, `charge_id`, `amount`, `created_at`) VALUES
(1, 1, 1, 150.00, '2026-07-04 01:09:14'),
(2, 2, 2, 150.00, '2026-07-04 01:11:15');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `academic_payment_plans`
--

CREATE TABLE `academic_payment_plans` (
  `id` int(11) NOT NULL,
  `cycle_id` int(11) NOT NULL,
  ...
  `monthly_due_day` tinyint(3) UNSIGNED NOT NULL DEFAULT 10,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(8, 2, 23, 'Holaaaaaaaaa, manana labo amigos', NULL, NULL, '2026-06-07 21:01:27', 0),
(9, 2, 23, 'Recuerden que el la proxima semana empezamos examenes, porfavor estudiar y echarle ganas.', NULL, NULL, '2026-07-04 01:28:52', 1);
...
(2, 30, 'Elias', 'Guevara', 'guevarajeremy682@gmail.com', '7934-6671', '2000-07-01', NULL, NULL, NULL, 'Elias Guevara', 'guevarajeremy682@gmail.com', 'DUI', '07505224-2', 'La Libertad', 'La Libertad Centro', '', 'Calle Chiltiupan Casa #27', NULL, 1, 'pending', 1, '2026-07-03 14:47:33', '2026-07-03 14:47:33');
...
(30, NULL, 'Shiroo', '1e530f2ebe345978fd0b64c3fcfc89f4c1abd474', NULL, NULL, 1);
...
--
-- Indices de la tabla `academic_charges`
--
ALTER TABLE `academic_charges`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_academic_charges_student_status` (`student_id`,`status`),
  ADD KEY `idx_academic_charges_cycle` (`cycle_id`),
  ADD KEY `idx_academic_charges_due_date` (`due_date`),
  ADD KEY `fk_academic_charges_plan` (`plan_id`),
  ADD KEY `fk_academic_charges_created_by` (`created_by`);

--
-- Indices de la tabla `academic_cycles`
--
ALTER TABLE `academic_cycles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_academic_cycles_name` (`name`);

--
-- Indices de la tabla `academic_dte_documents`
--
ALTER TABLE `academic_dte_documents`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_academic_dte_payment` (`payment_id`),
  ADD UNIQUE KEY `uq_academic_dte_numero_control` (`numero_control`),
  ADD UNIQUE KEY `uq_academic_dte_codigo_generacion` (`codigo_generacion`),
  ADD KEY `idx_academic_dte_student` (`student_id`),
  ADD KEY `idx_academic_dte_estado` (`estado`);

--
-- Indices de la tabla `academic_payments`
--
ALTER TABLE `academic_payments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_academic_payments_stripe_session` (`stripe_session_id`),
  ADD KEY `idx_academic_payments_student` (`student_id`),
  ADD KEY `idx_academic_payments_status` (`status`),
  ADD KEY `fk_academic_payments_cycle` (`cycle_id`),
  ADD KEY `fk_academic_payments_user` (`user_id`),
  ADD KEY `fk_academic_payments_created_by` (`created_by`);

--
-- Indices de la tabla `academic_payment_details`
--
ALTER TABLE `academic_payment_details`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_academic_payment_details` (`payment_id`,`charge_id`),
  ADD KEY `idx_academic_payment_details_charge` (`charge_id`);

--
-- Indices de la tabla `academic_payment_plans`
--
ALTER TABLE `academic_payment_plans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_academic_payment_plans_cycle` (`cycle_id`),
  ADD KEY `idx_academic_payment_plans_grade` (`grade_id`);
...
--
-- AUTO_INCREMENT de la tabla `academic_charges`
--
ALTER TABLE `academic_charges`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `academic_cycles`
--
ALTER TABLE `academic_cycles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `academic_dte_documents`
--
ALTER TABLE `academic_dte_documents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `academic_payments`
--
ALTER TABLE `academic_payments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `academic_payment_details`
--
ALTER TABLE `academic_payment_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `academic_payment_plans`
--
ALTER TABLE `academic_payment_plans`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `mensajes`
  MODIFY `mensaje_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `public_users`
  MODIFY `PUBLIC_USER_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Filtros para la tabla `academic_charges`
--
ALTER TABLE `academic_charges`
  ADD CONSTRAINT `fk_academic_charges_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_academic_charges_cycle` FOREIGN KEY (`cycle_id`) REFERENCES `academic_cycles` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_academic_charges_plan` FOREIGN KEY (`plan_id`) REFERENCES `academic_payment_plans` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_academic_charges_student` FOREIGN KEY (`student_id`) REFERENCES `estudiantes` (`ESTUDIANTE_ID`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `academic_payments`
--
ALTER TABLE `academic_payments`
  ADD CONSTRAINT `fk_academic_payments_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_academic_payments_cycle` FOREIGN KEY (`cycle_id`) REFERENCES `academic_cycles` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_academic_payments_student` FOREIGN KEY (`student_id`) REFERENCES `estudiantes` (`ESTUDIANTE_ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_academic_payments_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `academic_payment_details`
--
ALTER TABLE `academic_payment_details`
  ADD CONSTRAINT `fk_academic_payment_details_charge` FOREIGN KEY (`charge_id`) REFERENCES `academic_charges` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_academic_payment_details_payment` FOREIGN KEY (`payment_id`) REFERENCES `academic_payments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `academic_payment_plans`
--
ALTER TABLE `academic_payment_plans`
  ADD CONSTRAINT `fk_academic_payment_plans_cycle` FOREIGN KEY (`cycle_id`) REFERENCES `academic_cycles` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_academic_payment_plans_grade` FOREIGN KEY (`grade_id`) REFERENCES `grados` (`G_ID`) ON DELETE SET NULL ON UPDATE CASCADE;
