-- Copia SQL de Atenea
-- Fecha: 2026-07-21 11:40:21 (America/El_Salvador)
...
CREATE TABLE `contenidos` (
  ...
  `publicado_at` datetime DEFAULT NULL COMMENT 'Fecha real en que el contenido pasó por primera vez a publicado',
  `fecha_limite` datetime DEFAULT NULL,
  `estado` enum('borrador','activo','inactivo') NOT NULL DEFAULT 'borrador',
  `activo` tinyint(1) NOT NULL DEFAULT 1,
  `eliminado_at` datetime DEFAULT NULL COMMENT 'Marca de borrado lógico de la publicación',
  `eliminado_por` int(10) unsigned DEFAULT NULL COMMENT 'Usuario que eliminó lógicamente la publicación',
  ...
  KEY `idx_contenido_feed` (`seccion_id`,`estado`,`activo`,`eliminado_at`,`fecha_publicacion`,`created_at`),
  KEY `fk_contenido_eliminado_por` (`eliminado_por`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Estructura de contenido_comentarios
CREATE TABLE `contenido_comentarios` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador del comentario o respuesta',
  `contenido_id` bigint(20) unsigned NOT NULL COMMENT 'Publicación de clase a la que pertenece',
  `usuario_id` int(10) unsigned NOT NULL COMMENT 'Autor del mensaje',
  `parent_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Comentario principal al que responde; solo se admite un nivel',
  ...
  `editado_at` datetime DEFAULT NULL COMMENT 'Última edición realizada por el autor',
  `moderado_por` int(10) unsigned DEFAULT NULL COMMENT 'Docente o administrador que ocultó el mensaje',
  `moderado_at` datetime DEFAULT NULL COMMENT 'Fecha de moderación',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
...
(2458,1,NULL,'error_sistema','sistema','error','Error operativo: global','No puedes ver esta publicación.',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=1287','error:121675552e99cea1617fbca4a64e90dd8ea7a42c015389c4431f99047469de1e:2026-07-21-10:u:1',NULL,NULL,NULL,1287,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 10:54:00','2026-07-21 10:54:00'),
(2535,1,NULL,'error_sistema','sistema','error','Error operativo: global','SQLSTATE[HY000]: General error: 1271 Illegal mix of collations for operation \'UNION\'',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=1362','error:ca05a7898f7c5edfe397b2e4c93a9f78d95fb7f347f1e9f7c89f9f45fe349743:2026-07-21-10:u:1',NULL,NULL,NULL,1362,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 10:56:57','2026-07-21 10:56:57'),
(2564,1,NULL,'mensaje_nuevo','comunicaciones','informacion','Nuevo mensaje: PRUEBA 2','Teléfono: +503 6115-6808\n\ncrefwerfe',NULL,'/Atenea/src/dashboard/comunicaciones/hilo.php?id=3','hilo:nuevo:3:u:1',NULL,NULL,3,NULL,'normal','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 10:58:30','2026-07-21 10:58:30'),
(2572,1,NULL,'error_sistema','sistema','error','Error operativo: global','SQLSTATE[HY000]: General error: 1271 Illegal mix of collations for operation \'UNION\'',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=1362','error:ca05a7898f7c5edfe397b2e4c93a9f78d95fb7f347f1e9f7c89f9f45fe349743:2026-07-21-11:u:1',NULL,NULL,NULL,1362,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:05:35','2026-07-21 11:05:35'),
(2578,1,NULL,'error_sistema','sistema','error','Error operativo: global','Undefined array key \"icono\"',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=59','error:b16c579b3b469454884f60b77e1ad14fadf39bb638c893321cde2ba1c81e3d15:2026-07-21-11:u:1',NULL,NULL,NULL,59,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:12:34','2026-07-21 11:12:34'),
(2598,672,NULL,'cambio_cuenta','seguridad','informacion','Tu cuenta fue actualizada','Se modificaron estos datos: nombre, codigo_telefono, telefono, foto. Si no reconoces el cambio, contacta a soporte.',NULL,'/Atenea/src/notificaciones/index.php','cambio-cuenta:672:aaedb65e2b0f7ee818f94817782375117eab674c21d77386ade6bc702a302870:u:672',NULL,NULL,NULL,NULL,'normal','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:24:03','2026-07-21 11:24:03'),
(2600,672,NULL,'error_sistema','sistema','error','Error operativo: global','Undefined array key \"icono\"',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=59','error:b16c579b3b469454884f60b77e1ad14fadf39bb638c893321cde2ba1c81e3d15:2026-07-21-11:u:672',NULL,NULL,NULL,59,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:24:06','2026-07-21 11:24:06'),
(2615,1,NULL,'error_sistema','sistema','error','Error operativo: global','Intento de acceso a una ruta no autorizada.',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=1413','error:7fe227dea9a424d82122cdb98b530e501c2cd5c92c98e4fa8d622dc52a15831f:2026-07-21-11:u:1',NULL,NULL,NULL,1413,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:24:07','2026-07-21 11:24:07'),
(2616,672,NULL,'error_sistema','sistema','error','Error operativo: global','Intento de acceso a una ruta no autorizada.',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=1413','error:7fe227dea9a424d82122cdb98b530e501c2cd5c92c98e4fa8d622dc52a15831f:2026-07-21-11:u:672',NULL,NULL,NULL,1413,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:24:07','2026-07-21 11:24:07'),
(2618,1,NULL,'error_sistema','sistema','error','Error operativo: global','No puedes ver esta publicación.',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=1287','error:121675552e99cea1617fbca4a64e90dd8ea7a42c015389c4431f99047469de1e:2026-07-21-11:u:1',NULL,NULL,NULL,1287,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:26:14','2026-07-21 11:26:14'),
(2623,1,NULL,'error_sistema','sistema','error','Error operativo: global','atenea_e(): Argument #1 ($value) must be of type string, null given, called in C:\\xampp\\htdocs\\Atenea\\src\\docente\\contenido_editar.php on line 11',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=1415','error:ed805e264f5de0e61caacc6eaf7635cd21c67e5718dc8b7e03e88a1132713a5c:2026-07-21-11:u:1',NULL,NULL,NULL,1415,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:26:35','2026-07-21 11:26:35'),
(2624,1,3,'chat_nuevo','comunicaciones','informacion','Nuevo mensaje interno','CALLESE',NULL,'/Atenea/src/comunicaciones/chat.php?id=29','chat:mensaje:93:u:1',NULL,NULL,NULL,NULL,'normal','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:27:02','2026-07-21 11:27:02'),
(2661,704,NULL,'cambio_cuenta','seguridad','informacion','Tu cuenta fue actualizada','Se modificaron estos datos: nombre, codigo_telefono, telefono, foto. Si no reconoces el cambio, contacta a soporte.',NULL,'/Atenea/src/notificaciones/index.php','cambio-cuenta:704:8a18c953599513147330125a46b57fc6eb1b68ccf5296a91b89a342c4fded583:u:704',NULL,NULL,NULL,NULL,'normal','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:37:04','2026-07-21 11:37:04'),
(2663,704,NULL,'error_sistema','sistema','error','Error operativo: global','Undefined array key \"icono\"',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=59','error:b16c579b3b469454884f60b77e1ad14fadf39bb638c893321cde2ba1c81e3d15:2026-07-21-11:u:704',NULL,NULL,NULL,59,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:37:05','2026-07-21 11:37:05'),
(2695,704,NULL,'error_sistema','sistema','error','Error operativo: global','Intento de acceso a una ruta no autorizada.',NULL,'/Atenea/src/dashboard/errores/detalle.php?id=1413','error:7fe227dea9a424d82122cdb98b530e501c2cd5c92c98e4fa8d622dc52a15831f:2026-07-21-11:u:704',NULL,NULL,NULL,1413,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:37:08','2026-07-21 11:37:08'),
(2711,1,NULL,'error_correo','correo','error','Error operativo: cola','SMTP Error: Could not connect to SMTP host. Failed to connect to server',NULL,'/src/dashboard/errores/detalle.php?id=913','error:0c4fd5c89a141495fab2b2e2eed3682716a6672feed46b5526f54bc35f4a0990:2026-07-21-11:u:1',NULL,NULL,NULL,913,'alta','pendiente',NULL,NULL,NULL,NULL,NULL,'2026-07-21 11:38:47','2026-07-21 11:38:47');
...
(440,1,1,'auth.login_success','auth','user','1','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Chrome / Windows','aa0aa95ae4df715c9ce8ebff08602ffe','2026-07-21 10:51:45'),
(441,1,1,'auth.logout','auth','user','1','logout','success','Cierre de sesion exitoso.',NULL,'::1','Chrome / Windows','124d316c47f31236e7f0715247d01ea5','2026-07-21 10:53:28'),
(450,1,1,'auth.login_success','auth','user','1','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Chrome / Windows','d81a11ea6e6a91c843d8dabe6cc188ff','2026-07-21 10:56:25'),
(472,1,1,'auth.logout','auth','user','1','logout','success','Cierre de sesion exitoso.',NULL,'::1','Chrome / Windows','f33b2310b2a1abce5e66d99c1389cd3d','2026-07-21 10:58:15'),
(487,NULL,NULL,'auth.login_failed','auth',NULL,NULL,'login','failure','Falló un inicio de sesión por credenciales o estado de cuenta no válidos.',NULL,'::1','Edge / Windows','2c11414448ca5075deeb2d3bef6955fe','2026-07-21 11:00:00'),
(488,651,651,'auth.login_success','auth','user','651','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','296eb200730c893bcc5de8bacf7ae990','2026-07-21 11:00:02'),
(489,651,651,'auth.login_success','auth','user','651','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','bc0c38a61a4515eed57c3927aaca8f06','2026-07-21 11:00:26'),
(490,1,1,'auth.login_success','auth','user','1','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Chrome / Windows','4b9e9789e9611c15c4d60c8d564b62fb','2026-07-21 11:00:42'),
(491,652,652,'auth.login_success','auth','user','652','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','7efcfd323a0adb126f545898d6de2712','2026-07-21 11:02:14'),
(492,652,652,'auth.login_success','auth','user','652','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','4d79eb0b7f9bed8886d18a7fa8d4d730','2026-07-21 11:02:32'),
(493,NULL,NULL,'auth.login_failed','auth',NULL,NULL,'login','failure','Falló un inicio de sesión por credenciales o estado de cuenta no válidos.',NULL,'::1','Edge / Windows','65716917054f4dd1ae2c16483bd5234b','2026-07-21 11:03:05'),
(494,653,653,'auth.login_success','auth','user','653','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','62e364028c4d51f15e80c1eca3fd8f63','2026-07-21 11:05:35'),
(495,1,1,'auth.logout','auth','user','1','logout','success','Cierre de sesion exitoso.',NULL,'::1','Chrome / Windows','ad8f579b8a4d7b03bfdb86e364608b4a','2026-07-21 11:12:34'),
(496,3,3,'auth.login_success','auth','user','3','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Chrome / Windows','5c93aab981b0319934082a0376078e9a','2026-07-21 11:20:53'),
(501,672,672,'auth.login_success','auth','user','672','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','ab5f9066b9b1801e7b4fb1ebd38351b8','2026-07-21 11:23:52'),
(502,672,672,'auth.login_success','auth','user','672','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','e51d14b1ef1408969d5192fe0fc49660','2026-07-21 11:23:57'),
(503,672,672,'user.profile_updated','account','user','672','update','success','El usuario actualizó campos permitidos de su perfil.','{\"changed_fields\":[\"nombre\",\"codigo_telefono\",\"telefono\",\"foto\"],\"role_unchanged\":true}','::1','Edge / Windows','40a61634f0c996a5b698c791d41e039c','2026-07-21 11:24:03'),
(504,672,672,'auth.logout','auth','user','672','logout','success','Cierre de sesion exitoso.',NULL,'::1','Edge / Windows','1e5602ac42d3370e73b60742d7e83cce','2026-07-21 11:24:06'),
(505,673,673,'auth.login_success','auth','user','673','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','efb1988078223154c32a3e072fa67423','2026-07-21 11:24:07'),
(506,674,674,'auth.login_success','auth','user','674','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','ab57534c281b42432e13c76b4366c8e1','2026-07-21 11:25:03'),
(507,674,NULL,'database.sql_export.generated','backups','database_sql_export',NULL,'export','success','Un administrador generó una copia SQL de la base de datos.','{\"scope\":\"base\",\"content\":\"completa\",\"table\":null,\"tables\":81,\"rows\":803,\"size_bytes\":414425}','::1','Edge / Windows','444580c7a4c3a6d9b38d499271d04134','2026-07-21 11:25:04'),
(508,674,NULL,'database.sql_export.generated','backups','database_sql_export',NULL,'export','success','Un administrador generó una copia SQL de la base de datos.','{\"scope\":\"base\",\"content\":\"estructura\",\"table\":null,\"tables\":81,\"rows\":0,\"size_bytes\":85312}','::1','Edge / Windows','3f3b535da9e34471e8e274e199a20867','2026-07-21 11:25:05'),
(509,674,NULL,'database.sql_export.generated','backups','database_sql_export',NULL,'export','success','Un administrador generó una copia SQL de la base de datos.','{\"scope\":\"base\",\"content\":\"datos\",\"table\":null,\"tables\":81,\"rows\":805,\"size_bytes\":330362}','::1','Edge / Windows','7ac55af2693d5e765d84bbfcebbf4805','2026-07-21 11:25:06'),
(510,674,NULL,'database.sql_export.generated','backups','database_sql_export',NULL,'export','success','Un administrador generó una copia SQL de la base de datos.','{\"scope\":\"tabla\",\"content\":\"completa\",\"table\":\"usuarios\",\"tables\":1,\"rows\":7,\"size_bytes\":6260}','::1','Edge / Windows','5fafbbf5552075c18c19b0661c20dcf6','2026-07-21 11:25:06'),
(511,674,NULL,'database.sql_export.generated','backups','database_sql_export',NULL,'export','success','Un administrador generó una copia SQL de la base de datos.','{\"scope\":\"tabla\",\"content\":\"estructura\",\"table\":\"usuarios\",\"tables\":1,\"rows\":0,\"size_bytes\":3158}','::1','Edge / Windows','e625ee740b34765d4af3e98fe2618eb9','2026-07-21 11:25:07'),
(512,674,NULL,'database.sql_export.generated','backups','database_sql_export',NULL,'export','success','Un administrador generó una copia SQL de la base de datos.','{\"scope\":\"tabla\",\"content\":\"datos\",\"table\":\"usuarios\",\"tables\":1,\"rows\":7,\"size_bytes\":3628}','::1','Edge / Windows','e450156ace9aa0a1453331462dea1fc5','2026-07-21 11:25:07'),
(528,3,NULL,'chat.message.sent','communications','chat_message','93','create','success','Mensaje interno enviado.',NULL,'::1','Chrome / Windows','a37695e95dcaceff84fddd6f88e244fb','2026-07-21 11:27:02'),
(529,3,3,'auth.logout','auth','user','3','logout','success','Cierre de sesion exitoso.',NULL,'::1','Chrome / Windows','15d91fe9955ddfd3d7f8daf0137954f3','2026-07-21 11:27:07'),
(530,2,2,'auth.login_success','auth','user','2','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Chrome / Windows','ae234548d34a29dafc719d5e782af93c','2026-07-21 11:27:14'),
(531,2,2,'auth.logout','auth','user','2','logout','success','Cierre de sesion exitoso.',NULL,'::1','Chrome / Windows','5cf5a1dbef8215bbeb4028b9891d0cc9','2026-07-21 11:27:30'),
(542,692,692,'auth.login_success','auth','user','692','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','983c258435687fff7277aacba5e86426','2026-07-21 11:33:07'),
(543,692,692,'auth.login_success','auth','user','692','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','cf96abc112f2e8bf8577553931eab04c','2026-07-21 11:33:15'),
(544,693,693,'auth.login_success','auth','user','693','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','8a8217a5102216eb0a2c5e78f8ebc841','2026-07-21 11:33:29'),
(545,693,693,'auth.google_profile_completed','auth','user','693','complete_profile','success','Se completó el perfil obligatorio de una cuenta registrada con Google.',NULL,'::1','Edge / Windows','1d286f79bc6acd49e2875384c23ac992','2026-07-21 11:33:32'),
(546,695,695,'auth.login_success','auth','user','695','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','708e3e0eae70a1c4f94fb724642d4a85','2026-07-21 11:33:44'),
(555,695,695,'auth.login_success','auth','user','695','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','39bbde24cb3798cb6043c1dfa7244b46','2026-07-21 11:34:02'),
(576,704,704,'auth.login_success','auth','user','704','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','7dc0339ebca3f69329e6ab0187faff14','2026-07-21 11:36:52'),
(577,704,704,'auth.login_success','auth','user','704','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','b954208b09885bcc32a8ad2f998d42b2','2026-07-21 11:36:57'),
(578,704,704,'user.profile_updated','account','user','704','update','success','El usuario actualizó campos permitidos de su perfil.','{\"changed_fields\":[\"nombre\",\"codigo_telefono\",\"telefono\",\"foto\"],\"role_unchanged\":true}','::1','Edge / Windows','21a7e310ca6f3aa5a2060a42156845db','2026-07-21 11:37:04'),
(579,704,704,'auth.logout','auth','user','704','logout','success','Cierre de sesion exitoso.',NULL,'::1','Edge / Windows','d216adc307ae931a36ffb124922b6f0f','2026-07-21 11:37:07'),
(580,705,705,'auth.login_success','auth','user','705','login','success','Inicio de sesión exitoso.','{\"credential_upgraded\":false}','::1','Edge / Windows','e979685049f8a71b22638a2dc299e61e','2026-07-21 11:37:08'),
(581,715,NULL,'chat.message.sent','communications','chat_message','94','create','success','Mensaje interno enviado.',NULL,NULL,'CLI','fde61736dfca1f8c9a0e8dcfc13466c4','2026-07-21 11:38:45'),
(582,714,NULL,'chat.message.sent','communications','chat_message','95','create','success','Mensaje interno enviado.',NULL,NULL,'CLI','fde61736dfca1f8c9a0e8dcfc13466c4','2026-07-21 11:38:45'),
(583,1,NULL,'chat.message.sent','communications','chat_message','96','create','success','Mensaje interno enviado.',NULL,NULL,'CLI','fde61736dfca1f8c9a0e8dcfc13466c4','2026-07-21 11:38:45'),
(584,714,NULL,'chat.message.sent','communications','chat_message','97','create','success','Mensaje interno enviado.',NULL,NULL,'CLI','fde61736dfca1f8c9a0e8dcfc13466c4','2026-07-21 11:38:45');

-- Información de auth_remember_tokens
INSERT INTO `auth_remember_tokens` (`id`,`usuario_id`,`selector`,`token_hash`,`session_version`,`user_agent_hash`,`ip_hash`,`expires_at`,`last_used_at`,`revoked_at`,`created_at`) VALUES
(48,659,'9b7ce5d1f78c431807271ed6','a95e6fc28969bb6df4da98e80a2c569ebe3d4a97e591ed3fbaceee7e594f9188',1,'d4dfb83e0c423143ba7fb1a04bdc6d4eff21a080e846df96daeef3f7d91cd363','12ca17b49af2289436f303e0166030a21e525d266e209267433801a8fd4071a0','2026-08-20 11:22:49',NULL,'2026-07-21 11:22:49','2026-07-21 11:22:49'),
(50,729,'e1ba35d3548b129cde159a73','3e243d3e4d37edc5797b66094014622ebb01ca8287076628583e57e717fac105',1,'d4dfb83e0c423143ba7fb1a04bdc6d4eff21a080e846df96daeef3f7d91cd363','12ca17b49af2289436f303e0166030a21e525d266e209267433801a8fd4071a0','2026-08-20 11:38:50',NULL,'2026-07-21 11:38:50','2026-07-21 11:38:50'),
(51,731,'d693b138e6449ba7b54453a5','f820966b0b1e90199e23f54d3af630b95415a48049436538c0ed086a223c0723',1,'79f5b1c65df12b82a9b5b1df7e0fb91fa3db3f38113b2e6205785cae4a179595','12ca17b49af2289436f303e0166030a21e525d266e209267433801a8fd4071a0','2026-08-20 11:38:50',NULL,'2026-07-21 11:38:50','2026-07-21 11:38:50');
...
(36,692,'activo',1,'2026-07-21 11:33:13','2026-07-21 11:33:13');
...
(29,'individual','85f2ef987b76f4c3fc081acef84e0a730f5df8a2488a5bb7ddae4f7dee721ed8',3,'activa','2026-07-21 11:27:02','2026-07-17 19:43:16','2026-07-21 11:27:02'),
...
(93,3,'2026-07-21 11:27:02'),
(98,724,'2026-07-21 11:38:50'),
(98,727,'2026-07-21 11:38:50'),
(99,727,'2026-07-21 11:38:50');
...
(93,29,3,NULL,'CALLESE','2dc584d308af6c6f94fddcb846e057907ce06e77d917d610492bbd8daeee7615','activo',NULL,NULL,NULL,'2026-07-21 11:27:02','2026-07-21 11:27:02'),
(98,83,724,NULL,'Mensaje inicial','b35f3744e8df6acd8d86948061102573c2d838b278947e3a9724d174669cb670','activo','2026-07-21 11:38:50',NULL,NULL,'2026-07-21 11:38:50','2026-07-21 11:38:50'),
(99,83,727,98,'','9ddd43be742af3883c88e6ba5218988cf2fb8d5b5a2cad2c44dc4c8d1f4bd73b','eliminado',NULL,'2026-07-21 11:38:50',727,'2026-07-21 11:38:50','2026-07-21 11:38:50');
...
(29,3,93,'2026-07-17 19:43:16',NULL),
...
(83,724,NULL,'2026-07-21 11:38:50',NULL),
(83,727,98,'2026-07-21 11:38:50',NULL);

-- Información de chat_reportes
-- Información de comunicacion_hilos
INSERT INTO `comunicacion_hilos` (`id`,`canal`,`asunto`,`usuario_id`,`nombre_contacto`,`correo_contacto`,`pedido_id`,`asignatura_id`,`docente_id`,`estado`,`ultimo_mensaje_at`,`created_at`,`updated_at`) VALUES
(3,'contacto','PRUEBA 2',NULL,'Milton','rivasmilton513@gmail.com',NULL,NULL,NULL,'recibido','2026-07-21 10:58:30','2026-07-21 10:58:30','2026-07-21 10:58:30');

-- Información de comunicacion_mensajes
INSERT INTO `comunicacion_mensajes` (`id`,`hilo_id`,`direccion`,`autor_usuario_id`,`autor_nombre`,`autor_correo`,`contenido`,`correo_envio_id`,`resultado_envio`,`created_at`) VALUES
(3,3,'entrada',NULL,'Milton','rivasmilton513@gmail.com','Teléfono: +503 6115-6808\n\ncrefwerfe',NULL,'no_aplica','2026-07-21 10:58:30');
...
-- Información de contenido_comentarios
...
(375,'contacto_recibido','[Contacto Atenea] PRUEBA 2',NULL,NULL,3,'a********@gmail.com','90a6fd1924ceccac41c2ae7af0fd6bfaaea41c26feb1a31ee4780a7c84dd5fcf','ateneanaturopatia@gmail.com','Equipo Atenea','<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body style=\"margin:0;padding:0;background:#f7f4ec;color:#20251f;font-family:Arial,Helvetica,sans-serif;\"><div style=\"display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;\">Se recibió un nuevo mensaje desde el formulario de contacto.</div><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"background:#f7f4ec;\"><tr><td align=\"center\" style=\"padding:24px 12px;\"><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"max-width:640px;background:#ffffff;border:1px solid #e2dccd;border-radius:12px;overflow:hidden;\"><tr><td align=\"center\" style=\"padding:24px;background:#173f35;\"><img data-atenea-email-logo=\"1\" src=\"cid:atenea-logo\" width=\"150\" alt=\"Atenea Escuela de Naturopatía Holística\" style=\"display:block;margin:0 auto;max-width:150px;height:auto;border:0;outline:none;text-decoration:none;\"></td></tr><tr><td style=\"padding:32px 28px;\"><h1 style=\"margin:0 0 20px;color:#173f35;font-size:26px;line-height:1.25;\">Nuevo mensaje de contacto</h1><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"8\" style=\"background:#f7f4ec;border-radius:8px;\"><tr><td><strong>Nombre</strong></td><td>Milton</td></tr><tr><td><strong>Correo</strong></td><td>rivasmilton513@gmail.com</td></tr><tr><td><strong>Asunto</strong></td><td>PRUEBA 2</td></tr><tr><td valign=\"top\"><strong>Mensaje</strong></td><td>Teléfono: +503 6115-6808<br />\n<br />\ncrefwerfe</td></tr><tr><td><strong>Fecha</strong></td><td>21/07/2026 10:58:30 (El Salvador)</td></tr><tr><td><strong>Referencia técnica</strong></td><td>Formulario web · eff8e7ca5066</td></tr></table><p style=\"margin:24px 0;\"><a href=\"mailto:rivasmilton513@gmail.com\" style=\"display:inline-block;padding:13px 22px;background:#c49a3a;color:#ffffff;text-decoration:none;border-radius:7px;font-weight:700;\">Responder por correo</a></p></td></tr><tr><td style=\"padding:20px 28px;background:#f7f4ec;border-top:1px solid #e2dccd;text-align:center;color:#5a625b;font-size:12px;line-height:1.6;\">Atenea Escuela de Naturopatía Holística<br>Av. El Níspero Final, Huizúcar · ateneanaturopatia@gmail.com<br>Enviado el 21/07/2026 10:58 (hora de El Salvador)</td></tr></table></td></tr></table></body></html>','Nuevo mensaje de contacto\n\nNuevo mensaje de contacto\nNombre: Milton\nCorreo: rivasmilton513@gmail.com\nAsunto: PRUEBA 2\nMensaje:\nTeléfono: +503 6115-6808\n\ncrefwerfe\nFecha: 21/07/2026 10:58:30 (El Salvador)\n\nAtenea Escuela de Naturopatía Holística\nAv. El Níspero Final, Huizúcar\nEnviado el 21/07/2026 10:58 (hora de El Salvador)','{\"usuario_id\":null,\"idempotency_key\":\"contacto:5dc3d1158947b4ef1c0672589b401063bf5d729cae65469e62e5516c5dd2b44d\",\"reply_to\":\"rivasmilton513@gmail.com\",\"reply_to_name\":\"Milton\",\"hilo_id\":3,\"tipo\":\"contacto_recibido\"}','contacto:5dc3d1158947b4ef1c0672589b401063bf5d729cae65469e62e5516c5dd2b44d','contacto:5dc3d1158947b4ef1c0672589b401063bf5d729cae65469e62e5516c5dd2b44d',NULL,'cancelado','2026-07-21 10:58:30',0,3,1,0,1,NULL,NULL,NULL,'2026-07-21 10:58:30','Conservado sin envío por MAIL_TEST_MODE.','2026-07-21 10:58:30','2026-07-21 10:58:30'),
(376,'aviso_administrativo','Confirmación de cambios en tu cuenta Atenea',672,NULL,NULL,'c********@example.invalid','29fe9adea8a05703a4e43d07a792863841f1c048d742e9ab0ea6c379dcbb68e5','c7e12.admin@example.invalid','Administración Actualizada Etapa 12','<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body style=\"margin:0;padding:0;background:#f7f4ec;color:#20251f;font-family:Arial,Helvetica,sans-serif;\"><div style=\"display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;\">Se modificó información de tu cuenta.</div><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"background:#f7f4ec;\"><tr><td align=\"center\" style=\"padding:24px 12px;\"><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"max-width:640px;background:#ffffff;border:1px solid #e2dccd;border-radius:12px;overflow:hidden;\"><tr><td align=\"center\" style=\"padding:24px;background:#173f35;\"><img data-atenea-email-logo=\"1\" src=\"cid:atenea-logo\" width=\"150\" alt=\"Atenea Escuela de Naturopatía Holística\" style=\"display:block;margin:0 auto;max-width:150px;height:auto;border:0;outline:none;text-decoration:none;\"></td></tr><tr><td style=\"padding:32px 28px;\"><h1 style=\"margin:0 0 20px;color:#173f35;font-size:26px;line-height:1.25;\">Confirmación de cambios en tu cuenta Atenea</h1><p style=\"margin:0 0 16px;line-height:1.65;\">Hola, Administración Actualizada Etapa 12.</p><p style=\"margin:0 0 16px;line-height:1.65;\">Se modificó tu cuenta el 21/07/2026 11:24.<br />\nCampos: nombre, codigo_telefono, telefono, foto<br />\nOrigen aproximado: ::1::/48<br />\nSi no reconoces este cambio, contacta al soporte de Atenea.</p></td></tr><tr><td style=\"padding:20px 28px;background:#f7f4ec;border-top:1px solid #e2dccd;text-align:center;color:#5a625b;font-size:12px;line-height:1.6;\">Atenea Escuela de Naturopatía Holística<br>Av. El Níspero Final, Huizúcar · ateneanaturopatia@gmail.com<br>Enviado el 21/07/2026 11:24 (hora de El Salvador)</td></tr></table></td></tr></table></body></html>','Confirmación de cambios en tu cuenta Atenea\n\nHola, Administración Actualizada Etapa 12.\n\nSe modificó tu cuenta el 21/07/2026 11:24.\nCampos: nombre, codigo_telefono, telefono, foto\nOrigen aproximado: ::1::/48\nSi no reconoces este cambio, contacta al soporte de Atenea.\n\nAtenea Escuela de Naturopatía Holística\nAv. El Níspero Final, Huizúcar\nEnviado el 21/07/2026 11:24 (hora de El Salvador)','{\"usuario_id\":672,\"categoria\":\"seguridad\",\"evento_id\":\"cambio-cuenta:672:aaedb65e2b0f7ee818f94817782375117eab674c21d77386ade6bc702a302870\",\"idempotency_key\":\"cambio-cuenta:672:aaedb65e2b0f7ee818f94817782375117eab674c21d77386ade6bc702a302870\",\"tipo\":\"aviso_administrativo\"}','cambio-cuenta:672:aaedb65e2b0f7ee818f94817782375117eab674c21d77386ade6bc702a302870','cambio-cuenta:672:aaedb65e2b0f7ee818f94817782375117eab674c21d77386ade6bc702a302870',NULL,'cancelado','2026-07-21 11:24:03',0,3,1,0,1,NULL,NULL,NULL,'2026-07-21 11:24:03','Conservado sin envío por MAIL_TEST_MODE.','2026-07-21 11:24:03','2026-07-21 11:24:03'),
(377,'aviso_administrativo','Confirmación de cambios en tu cuenta Atenea',704,NULL,NULL,'c********@example.invalid','29fe9adea8a05703a4e43d07a792863841f1c048d742e9ab0ea6c379dcbb68e5','c7e12.admin@example.invalid','Administración Actualizada Etapa 12','<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body style=\"margin:0;padding:0;background:#f7f4ec;color:#20251f;font-family:Arial,Helvetica,sans-serif;\"><div style=\"display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;\">Se modificó información de tu cuenta.</div><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"background:#f7f4ec;\"><tr><td align=\"center\" style=\"padding:24px 12px;\"><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"max-width:640px;background:#ffffff;border:1px solid #e2dccd;border-radius:12px;overflow:hidden;\"><tr><td align=\"center\" style=\"padding:24px;background:#173f35;\"><img data-atenea-email-logo=\"1\" src=\"cid:atenea-logo\" width=\"150\" alt=\"Atenea Escuela de Naturopatía Holística\" style=\"display:block;margin:0 auto;max-width:150px;height:auto;border:0;outline:none;text-decoration:none;\"></td></tr><tr><td style=\"padding:32px 28px;\"><h1 style=\"margin:0 0 20px;color:#173f35;font-size:26px;line-height:1.25;\">Confirmación de cambios en tu cuenta Atenea</h1><p style=\"margin:0 0 16px;line-height:1.65;\">Hola, Administración Actualizada Etapa 12.</p><p style=\"margin:0 0 16px;line-height:1.65;\">Se modificó tu cuenta el 21/07/2026 11:37.<br />\nCampos: nombre, codigo_telefono, telefono, foto<br />\nOrigen aproximado: ::1::/48<br />\nSi no reconoces este cambio, contacta al soporte de Atenea.</p></td></tr><tr><td style=\"padding:20px 28px;background:#f7f4ec;border-top:1px solid #e2dccd;text-align:center;color:#5a625b;font-size:12px;line-height:1.6;\">Atenea Escuela de Naturopatía Holística<br>Av. El Níspero Final, Huizúcar · ateneanaturopatia@gmail.com<br>Enviado el 21/07/2026 11:37 (hora de El Salvador)</td></tr></table></td></tr></table></body></html>','Confirmación de cambios en tu cuenta Atenea\n\nHola, Administración Actualizada Etapa 12.\n\nSe modificó tu cuenta el 21/07/2026 11:37.\nCampos: nombre, codigo_telefono, telefono, foto\nOrigen aproximado: ::1::/48\nSi no reconoces este cambio, contacta al soporte de Atenea.\n\nAtenea Escuela de Naturopatía Holística\nAv. El Níspero Final, Huizúcar\nEnviado el 21/07/2026 11:37 (hora de El Salvador)','{\"usuario_id\":704,\"categoria\":\"seguridad\",\"evento_id\":\"cambio-cuenta:704:8a18c953599513147330125a46b57fc6eb1b68ccf5296a91b89a342c4fded583\",\"idempotency_key\":\"cambio-cuenta:704:8a18c953599513147330125a46b57fc6eb1b68ccf5296a91b89a342c4fded583\",\"tipo\":\"aviso_administrativo\"}','cambio-cuenta:704:8a18c953599513147330125a46b57fc6eb1b68ccf5296a91b89a342c4fded583','cambio-cuenta:704:8a18c953599513147330125a46b57fc6eb1b68ccf5296a91b89a342c4fded583',NULL,'cancelado','2026-07-21 11:37:04',0,3,1,0,1,NULL,NULL,NULL,'2026-07-21 11:37:04','Conservado sin envío por MAIL_TEST_MODE.','2026-07-21 11:37:04','2026-07-21 11:37:04'),
(378,'aviso_administrativo','Asignación académica completada · Temporal A',707,NULL,NULL,'c********@example.invalid','38330d9569fe249e62464e6abb6e4ed304783c8f0d9891267c158f08e989a656','c6e3_72d3c69b2@example.invalid','Tmp2 Integración','<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body style=\"margin:0;padding:0;background:#f7f4ec;color:#20251f;font-family:Arial,Helvetica,sans-serif;\"><div style=\"display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;\">Tu sección y docente ya fueron asignados.</div><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"background:#f7f4ec;\"><tr><td align=\"center\" style=\"padding:24px 12px;\"><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"max-width:640px;background:#ffffff;border:1px solid #e2dccd;border-radius:12px;overflow:hidden;\"><tr><td align=\"center\" style=\"padding:24px;background:#173f35;\"><img data-atenea-email-logo=\"1\" src=\"cid:atenea-logo\" width=\"150\" alt=\"Atenea Escuela de Naturopatía Holística\" style=\"display:block;margin:0 auto;max-width:150px;height:auto;border:0;outline:none;text-decoration:none;\"></td></tr><tr><td style=\"padding:32px 28px;\"><h1 style=\"margin:0 0 20px;color:#173f35;font-size:26px;line-height:1.25;\">Asignación académica completada · Temporal A</h1><p style=\"margin:0 0 16px;line-height:1.65;\">Hola, Tmp2 Integración.</p><p style=\"margin:0 0 16px;line-height:1.65;\">Sección: Sección llena (c6e3_72d3c69b-S29). Docente: Tmp1 Integración. Horario: por confirmar. Inicio: por confirmar.</p><p style=\"margin:24px 0;\"><a href=\"http://localhost/Atenea/src/estudiantes/clase.php\" style=\"display:inline-block;padding:13px 22px;background:#c49a3a;color:#ffffff;text-decoration:none;border-radius:7px;font-weight:700;\">Ver mi clase</a></p></td></tr><tr><td style=\"padding:20px 28px;background:#f7f4ec;border-top:1px solid #e2dccd;text-align:center;color:#5a625b;font-size:12px;line-height:1.6;\">Atenea Escuela de Naturopatía Holística<br>Av. El Níspero Final, Huizúcar · ateneanaturopatia@gmail.com<br>Enviado el 21/07/2026 11:38 (hora de El Salvador)</td></tr></table></td></tr></table></body></html>','Asignación académica completada · Temporal A\n\nHola, Tmp2 Integración.\n\nSección: Sección llena (c6e3_72d3c69b-S29). Docente: Tmp1 Integración. Horario: por confirmar. Inicio: por confirmar.\n\nAtenea Escuela de Naturopatía Holística\nAv. El Níspero Final, Huizúcar\nEnviado el 21/07/2026 11:38 (hora de El Salvador)','{\"usuario_id\":707,\"idempotency_key\":\"capacitacion-asignada:inscripcion:272\",\"tipo\":\"aviso_administrativo\"}','capacitacion-asignada:inscripcion:272','capacitacion-asignada:inscripcion:272',NULL,'cancelado','2026-07-21 11:38:44',0,3,1,0,1,NULL,NULL,NULL,'2026-07-21 11:38:44','Conservado sin envío por MAIL_TEST_MODE.','2026-07-21 11:38:44','2026-07-21 11:38:44'),
(381,'aviso_administrativo','Asignación académica completada · Temporal CONC',707,NULL,NULL,'c********@example.invalid','38330d9569fe249e62464e6abb6e4ed304783c8f0d9891267c158f08e989a656','c6e3_72d3c69b2@example.invalid','Tmp2 Integración','<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body style=\"margin:0;padding:0;background:#f7f4ec;color:#20251f;font-family:Arial,Helvetica,sans-serif;\"><div style=\"display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;\">Tu sección y docente ya fueron asignados.</div><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"background:#f7f4ec;\"><tr><td align=\"center\" style=\"padding:24px 12px;\"><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"max-width:640px;background:#ffffff;border:1px solid #e2dccd;border-radius:12px;overflow:hidden;\"><tr><td align=\"center\" style=\"padding:24px;background:#173f35;\"><img data-atenea-email-logo=\"1\" src=\"cid:atenea-logo\" width=\"150\" alt=\"Atenea Escuela de Naturopatía Holística\" style=\"display:block;margin:0 auto;max-width:150px;height:auto;border:0;outline:none;text-decoration:none;\"></td></tr><tr><td style=\"padding:32px 28px;\"><h1 style=\"margin:0 0 20px;color:#173f35;font-size:26px;line-height:1.25;\">Asignación académica completada · Temporal CONC</h1><p style=\"margin:0 0 16px;line-height:1.65;\">Hola, Tmp2 Integración.</p><p style=\"margin:0 0 16px;line-height:1.65;\">Sección: Último cupo concurrente (c6e3_72d3c69b-CONC). Docente: Tmp5 Integración. Horario: por confirmar. Inicio: por confirmar.</p><p style=\"margin:24px 0;\"><a href=\"http://localhost/Atenea/src/estudiantes/clase.php\" style=\"display:inline-block;padding:13px 22px;background:#c49a3a;color:#ffffff;text-decoration:none;border-radius:7px;font-weight:700;\">Ver mi clase</a></p></td></tr><tr><td style=\"padding:20px 28px;background:#f7f4ec;border-top:1px solid #e2dccd;text-align:center;color:#5a625b;font-size:12px;line-height:1.6;\">Atenea Escuela de Naturopatía Holística<br>Av. El Níspero Final, Huizúcar · ateneanaturopatia@gmail.com<br>Enviado el 21/07/2026 11:38 (hora de El Salvador)</td></tr></table></td></tr></table></body></html>','Asignación académica completada · Temporal CONC\n\nHola, Tmp2 Integración.\n\nSección: Último cupo concurrente (c6e3_72d3c69b-CONC). Docente: Tmp5 Integración. Horario: por confirmar. Inicio: por confirmar.\n\nAtenea Escuela de Naturopatía Holística\nAv. El Níspero Final, Huizúcar\nEnviado el 21/07/2026 11:38 (hora de El Salvador)','{\"usuario_id\":707,\"idempotency_key\":\"capacitacion-asignada:inscripcion:274\",\"tipo\":\"aviso_administrativo\"}','capacitacion-asignada:inscripcion:274','capacitacion-asignada:inscripcion:274',NULL,'cancelado','2026-07-21 11:38:44',0,3,1,0,1,NULL,NULL,NULL,'2026-07-21 11:38:44','Conservado sin envío por MAIL_TEST_MODE.','2026-07-21 11:38:44','2026-07-21 11:38:44'),
(383,'aviso_administrativo','Asignación académica completada · Temporal A',708,NULL,NULL,'c********@example.invalid','8f1e07a876303bd002301658a427d79d81c22fd0bad2dbe965811c4a2f7ad074','c6e3_72d3c69b3@example.invalid','Tmp3 Integración','<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body style=\"margin:0;padding:0;background:#f7f4ec;color:#20251f;font-family:Arial,Helvetica,sans-serif;\"><div style=\"display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;\">Tu sección y docente ya fueron asignados.</div><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"background:#f7f4ec;\"><tr><td align=\"center\" style=\"padding:24px 12px;\"><table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"max-width:640px;background:#ffffff;border:1px solid #e2dccd;border-radius:12px;overflow:hidden;\"><tr><td align=\"center\" style=\"padding:24px;background:#173f35;\"><img data-atenea-email-logo=\"1\" src=\"cid:atenea-logo\" width=\"150\" alt=\"Atenea Escuela de Naturopatía Holística\" style=\"display:block;margin:0 auto;max-width:150px;height:auto;border:0;outline:none;text-decoration:none;\"></td></tr><tr><td style=\"padding:32px 28px;\"><h1 style=\"margin:0 0 20px;color:#173f35;font-size:26px;line-height:1.25;\">Asignación académica completada · Temporal A</h1><p style=\"margin:0 0 16px;line-height:1.65;\">Hola, Tmp3 Integración.</p><p style=\"margin:0 0 16px;line-height:1.65;\">Sección: Destino manual (c6e3_72d3c69b-DEST). Docente: Tmp1 Integración. Horario: por confirmar. Inicio: por confirmar.</p><p style=\"margin:24px 0;\"><a href=\"http://localhost/Atenea/src/estudiantes/clase.php\" style=\"display:inline-block;padding:13px 22px;background:#c49a3a;color:#ffffff;text-decoration:none;border-radius:7px;font-weight:700;\">Ver mi clase</a></p></td></tr><tr><td style=\"padding:20px 28px;background:#f7f4ec;border-top:1px solid #e2dccd;text-align:center;color:#5a625b;font-size:12px;line-height:1.6;\">Atenea Escuela de Naturopatía Holística<br>Av. El Níspero Final, Huizúcar · ateneanaturopatia@gmail.com<br>Enviado el 21/07/2026 11:38 (hora de El Salvador)</td></tr></table></td></tr></table></body></html>','Asignación académica completada · Temporal A\n\nHola, Tmp3 Integración.\n\nSección: Destino manual (c6e3_72d3c69b-DEST). Docente: Tmp1 Integración. Horario: por confirmar. Inicio: por confirmar.\n\nAtenea Escuela de Naturopatía Holística\nAv. El Níspero Final, Huizúcar\nEnviado el 21/07/2026 11:38 (hora de El Salvador)','{\"usuario_id\":708,\"idempotency_key\":\"capacitacion-asignada:inscripcion:273\",\"tipo\":\"aviso_administrativo\"}','capacitacion-asignada:inscripcion:273','capacitacion-asignada:inscripcion:273',NULL,'cancelado','2026-07-21 11:38:44',0,3,1,0,1,NULL,NULL,NULL,'2026-07-21 11:38:44','Conservado sin envío por MAIL_TEST_MODE.','2026-07-21 11:38:44','2026-07-21 11:38:44');
...
(59,'b16c579b3b469454884f60b77e1ad14fadf39bb638c893321cde2ba1c81e3d15','sistema','global','critico','Undefined array key \"icono\"','{\"tracking_id\":\"18E454F598E7\",\"status\":\"500\",\"uri\":\"\\/Atenea\\/index.php\",\"method\":\"GET\",\"usuario_id\":\"\"}',1328,'nuevo',NULL,NULL,NULL,NULL,'2026-07-20 11:51:31','2026-07-21 11:37:07',NULL,'2026-07-20 11:51:31','2026-07-21 11:37:07'),
...
(913,'0c4fd5c89a141495fab2b2e2eed3682716a6672feed46b5526f54bc35f4a0990','correo','cola','error','SMTP Error: Could not connect to SMTP host. Failed to connect to server','{\"correo_envio_id\":\"384\"}',4,'nuevo',NULL,NULL,NULL,NULL,'2026-07-20 21:48:31','2026-07-21 11:38:47',NULL,'2026-07-20 21:48:31','2026-07-21 11:38:47'),
(1287,'121675552e99cea1617fbca4a64e90dd8ea7a42c015389c4431f99047469de1e','sistema','global','advertencia','No puedes ver esta publicación.','{\"tracking_id\":\"E364E3535CCA\",\"status\":\"403\",\"uri\":\"\\/Atenea\\/src\\/docente\\/contenido-vista.php?id=32\",\"method\":\"GET\",\"usuario_id\":\"701\"}',9,'nuevo',NULL,624,NULL,NULL,'2026-07-21 10:54:00','2026-07-21 11:36:14',NULL,'2026-07-21 10:54:00','2026-07-21 11:36:14'),
(1362,'ca05a7898f7c5edfe397b2e4c93a9f78d95fb7f347f1e9f7c89f9f45fe349743','sistema','global','critico','SQLSTATE[HY000]: General error: 1271 Illegal mix of collations for operation \'UNION\'','{\"tracking_id\":\"2ED745192873\",\"status\":\"500\",\"uri\":\"\\/Atenea\\/src\\/estudiantes\\/index.php\",\"method\":\"GET\",\"usuario_id\":\"653\"}',8,'nuevo',NULL,637,NULL,NULL,'2026-07-21 10:56:57','2026-07-21 11:05:36',NULL,'2026-07-21 10:56:57','2026-07-21 11:05:36'),
(1413,'7fe227dea9a424d82122cdb98b530e501c2cd5c92c98e4fa8d622dc52a15831f','sistema','global','advertencia','Intento de acceso a una ruta no autorizada.','{\"tracking_id\":\"6DD010FE76FF\",\"status\":\"403\",\"uri\":\"\\/Atenea\\/src\\/dashboard\\/backups\\/index.php\",\"method\":\"GET\",\"usuario_id\":\"705\"}',2,'nuevo',NULL,673,NULL,NULL,'2026-07-21 11:24:07','2026-07-21 11:37:08',NULL,'2026-07-21 11:24:07','2026-07-21 11:37:08'),
(1415,'ed805e264f5de0e61caacc6eaf7635cd21c67e5718dc8b7e03e88a1132713a5c','sistema','global','critico','atenea_e(): Argument #1 ($value) must be of type string, null given, called in C:\\xampp\\htdocs\\Atenea\\src\\docente\\contenido_editar.php on line 11','{\"tracking_id\":\"754CBC8BCB58\",\"status\":\"500\",\"uri\":\"\\/Atenea\\/src\\/docente\\/contenido_editar.php?id=21\",\"method\":\"GET\",\"usuario_id\":\"684\"}',3,'nuevo',NULL,676,NULL,NULL,'2026-07-21 11:26:35','2026-07-21 11:31:43',NULL,'2026-07-21 11:26:35','2026-07-21 11:31:43');
...
INSERT INTO `historial_cambios_cuenta` (`id`,`usuario_id`,`accion`,`campos_modificados`,`ip_hash`,`sesion_hash`,`created_at`) VALUES
(21,672,'actualizacion_perfil','nombre, codigo_telefono, telefono, foto','eff8e7ca506627fe15dda5e0e512fcaad70b6d520f37cc76597fdb4f2d83a1a3','e10d9d44f9f4583239a62559dcea79a6c3e7f7dc677e4011c13edea92a8ade3a','2026-07-21 11:24:03'),
(22,704,'actualizacion_perfil','nombre, codigo_telefono, telefono, foto','eff8e7ca506627fe15dda5e0e512fcaad70b6d520f37cc76597fdb4f2d83a1a3','02bf85b7074da28554a17a3c6feade9a40157859c9e7759a0abb3df61182f638','2026-07-21 11:37:04');
...
(1,'Administrador','Atenea','usuario1','admin@atenea.local','$2y$10$tZYxPvtkyhKnO/2VpQnQc.YYpwQeE7AN9TZD15bQbhvMjIv34Qd3a',NULL,'local',0,'completo',NULL,NULL,'admin',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'activo','2026-07-21 11:00:42','2026-07-21 11:03:26',NULL,NULL,NULL,NULL,NULL,0,0,1,'2026-07-12 00:10:24','2026-07-21 11:03:26'),
(2,'Estudiante','Prueba','usuario2','usuario@atenea.local','$2y$10$LvTAn24ohthhMmndRScxueAOqiAkJBkt8PO/F2U2qZHh0AV3s/qhy',NULL,'local',0,'completo',NULL,NULL,'usuario',0,NULL,'2005-08-24','06956257-2','+503','61156808',3,14,53,NULL,'activo','2026-07-21 11:27:14','2026-07-21 11:27:14',NULL,NULL,NULL,NULL,NULL,0,0,1,'2026-07-12 00:10:24','2026-07-21 11:27:14'),
(3,'Docente','Prueba','usuario3','docente@atenea.local','$2y$10$TnN5bvlQa/Z3ACzvbVQLHu0fUJ5.Xt20sj1uSb/XgEu6ulKTyBj..',NULL,'local',0,'completo',NULL,NULL,'docente',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'activo','2026-07-21 11:20:53','2026-07-21 11:27:03',NULL,NULL,NULL,NULL,NULL,0,0,1,'2026-07-12 00:10:24','2026-07-21 11:27:03'),
...
DELIMITER $$
CREATE TRIGGER `trg_capacitacion_publicacion_carga` BEFORE UPDATE ON `asignaturas` FOR EACH ROW BEGIN
...
DELIMITER $$
CREATE TRIGGER `trg_docente_capacitacion_max_insert` BEFORE INSERT ON `docentes_asignaturas` FOR EACH ROW BEGIN
...
DELIMITER $$
CREATE TRIGGER `trg_docente_capacitacion_max_update` BEFORE UPDATE ON `docentes_asignaturas` FOR EACH ROW BEGIN
  DECLARE carga INT DEFAULT 0;
  IF NEW.estado='activo' THEN
    SELECT COUNT(DISTINCT da.asignatura_id) INTO carga
    FROM docentes_asignaturas da
