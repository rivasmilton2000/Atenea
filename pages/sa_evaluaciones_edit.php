...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT e.evaluacion_id, e.titulo, e.descripcion, e.fecha, e.porcentaje, e.contenido_id, e.evaluacion_estado,
...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        ...
        <div class="card-body">
            <form role="form" method="post" action="sa_evaluaciones_edit1.php">
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control"  name="descripcion" rows="3" minlength="5"  maxlength="250" required><?php echo $descripcion; ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" id="porcentaje" name="porcentaje" placeholder="Ingrese un porcentaje de evaluación hasta el 100%." value="<?php echo $porcentaje; ?>" min="0" max="100" required>
                    </div>
                </div>
...
<div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="evaluacion_estado" required>
                            <option value="1" <?php echo ($evaluacion_estado == 1) ? 'selected' : ''; ?>>Activo</option>
                            <option value="0" <?php echo ($evaluacion_estado == 0) ? 'selected' : ''; ?>>Inactivo</option>
                        </select>
                    </div>
                </div>
