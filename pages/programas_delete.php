...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT imagen FROM programas_educativos WHERE id = '$id'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // $sql = "UPDATE programas_educativos SET estado = 0 WHERE id = '$id'";
        
        // Opción 2: Eliminación física
        $sql = "DELETE FROM programas_educativos WHERE id = '$id'";
