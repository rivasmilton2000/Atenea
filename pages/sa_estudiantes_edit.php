...
$query = "SELECT e.ESTUDIANTE_ID, e.nombres_estudiante, e.apellidos_estudiante, e.direccion_estudiante, e.correo_estudiante, e.fecha_nac_estudiante, e.edad_estudiante, e.genero_estudiante, g.G_NAME AS grado, g.G_ID AS grado_id, e.carnet_estudiante, e.numero_lista_estudiante, e.info_medica_estudiante, e.fecha_reg_estudiante, e.foto_estudiante, e.estado_estudiante
FROM estudiantes e
...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        ...
        <div class="card-body">
            <form role="form" method="post" action="sa_estudiantes_edit3.php" enctype="multipart/form-data">
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="email" placeholder="Correo electrónico" name="correo_estudiante" minlength="10" maxlength="55" value="<?php echo $row['correo_estudiante']; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control fecha" readonly placeholder="Fecha de nacimiento" name="fecha_nac_estudiante" value="<?php echo date('d-m-Y', strtotime($row['fecha_nac_estudiante'])); ?>" required>
                    </div>
                </div>
    ...
    <div class="col-sm-9">
        <select class="form-control" name="estado_estudiante" required>
            ...
            <option value="1" <?php if ($row['estado_estudiante'] == 'Activo') echo 'selected'; ?>>Activo</option>
            <option value="0" <?php if ($row['estado_estudiante'] == 'Inactivo') echo 'selected'; ?>>Inactivo</option>
        </select>
    </div>
</div>
