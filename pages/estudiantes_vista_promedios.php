...
if (mysqli_num_rows($resultStudent) > 0) {
    ...
    <a href="estudiantes_vista_promedio1.php?asignatura_id=<?php echo $rowSubject['ASIGNATURA_ID']; ?>&ed_id=<?php echo $rowSubject['ed_id']; ?>" class="btn btn-light mb-2">Acceder</a>
</div>
                                </div>
                            </div>
                        </div>
