...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT a_id, nombre_archivo, permisos, fecha_subida, a_estado FROM archivos WHERE a_id = $id";
    $result = mysqli_query($db, $query) or die(mysqli_error($db));
...
$estadoBadge = obtenerEstadoBadge($estado);
?>
