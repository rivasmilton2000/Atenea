...
function pre_r($array){
    ...
    echo '</pre>';
                ...
                ?>
                <div class="row legacy-shell-panel">
                <div class="col-lg-12">
                  <div class="card shadow mb-0 w-100">
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">Categoría de productos</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#keyboard" data-toggle="tab">Teclado</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#mouse" data-toggle="tab">Mouse</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#headset" data-toggle="tab">Auriculares</a>
                              </li>
                              <li class="nav-item">
                              ...
                              <li class="nav-item">
                                <a class="nav-link" href="#processor" data-toggle="tab">Procesador</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#powersupply" data-toggle="tab">Fuente de alimentación</a>
                              </li>
                              <li class="nav-item">
...
<!-- END TAB PANE AREA - ANG UNOD KA TABS ARA SA TABPANE.PHP -->
        ...
        <br />  
        <div class="card shadow mb-4 col-md-12 legacy-shell-pos-card">
        <div class="card-header py-3 bg-white">
          <h4 class="m-2 font-weight-bold text-primary">Punto de venta</h4>
        </div>
        
      <div class="row">    
      <div class="card-body col-md-9 legacy-shell-product-grid">
