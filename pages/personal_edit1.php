...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($old_data['FIRST_NAME'] == $a && 
            ...
            if ($count > 0) {
                ...
                if ($count > 0) {
                    ...
                    $query = 'UPDATE employee SET FIRST_NAME = ?, LAST_NAME = ?, GENDER = ?, EMAIL = ?, LOCATION_ID = ?, PHONE_NUMBER = ?, HIRED_DATE = ? WHERE EMPLOYEE_ID = ?';
                    ...
                    if ($stmt === false) {
                        ...
                        // Vincular parámetros
                        if (!mysqli_stmt_bind_param($stmt, "ssssissi", $a, $b, $c, $f, $location_id, $g, $i, $zz)) {
                            $alertTitle = 'Error';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = 'personal.php?id=" . $zz . "';
                }
            });
        });
    </script>
    ...
    error_log("Intento de acceso directo a personal_edit1.php sin envío de formulario");
