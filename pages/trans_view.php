...
<hr>
              <div class="form-group row text-left mb-0 py-2">
                ...
                <div class="col-sm-4 py-1">
                  <h6>
                  Número de transacción<?php echo $tid; ?>
                  </h6>
                  <h6 class="font-weight-bold">
...
?>
            ...
            <div class="form-group row text-left mb-0 py-2">
                ...
                <div class="col-sm-4 py-1">
                  <h4>
                  Importe en efectivo: $ <?php echo number_format($cash, 2); ?>
                  </h4>
                  <table width="100%">
                    <tr>
                    ...
                    <tr>
                      <td class="font-weight-bold">Sin IVA</td>
                      <td class="text-right">$ <?php echo $net; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Ingresar IVA</td>
