...
$changes_made = $new_photo_uploaded ||
    ...
    $estado_estudiante !== $original_data['estado_estudiante'];
...
if (mysqli_stmt_execute($stmt)) {
    showAlert('Éxito', 'Estudiante actualizado exitosamente', 'success');
} else {
    showAlert('Error en la base de datos', 'Lo siento, hubo un error al actualizar los datos del estudiante.', 'error');
}
