                    ...
                    <div class="card">
                        ...
                        <div class="card-body <?php echo $colorClass; ?> text-white">
                            ...
                            <div class="d-flex flex-wrap justify-content-between">
                                <a href="docentes_vista_contenidos.php?id=<?php echo $rowSubject['da_id']; ?>" class="btn btn-light mb-2">Acceder</a>
                                <a href="docentes_vista_estudiantes.php?id=<?php echo $rowSubject['da_id']; ?>" class="btn btn-light mb-2">Ver estudiantes</a>
                            </div>
                        </div>
                    </div>
                </div>
