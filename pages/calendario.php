...
include '../includes/sidebar_admin.php'; // Cambiado a sidebar_admin.php
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if ($Aa == 'Personal' || $Aa == 'Estudiante' || $Aa == 'Docente' || $Aa == 'SuperAdmin') {
        if ($Aa == 'Personal') {
            ...
            $redirectUrl = "sa_vista.php"; // Cambiado a sa_vista.php
        }
        ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="post" action="calendario_transac.php?action=add"> <!-- Cambiado a calendario_transac.php -->
                    <div class="form-group">
                        <input class="form-control" inlength="5" maxlength="110" placeholder="Nombre de la actividad" name="act_nombre" required>
                    </div>
                    <div class="form-group">
        ...
        eventClick: function(event, jsEvent, view) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `calendario_edit.php?id=${event.id}`;
...
function confirmDelete(actividadId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch('calendario_delete.php?id=' + actividadId)
                ...
                if (response.success === false) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                url: 'calendario_transac.php?action=add',
                                method: 'POST',
