...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT i_id, articulo, cantidad, i_estado FROM inventario WHERE i_id = ?";
...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        ...
        <div class="card-body">
            <form role="form" method="post" action="sa_inventario_edit1.php">
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" placeholder="Nombre del artículo" name="articulo" minlength="5" maxlength="55" value="<?php echo $articulo; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="estado" required>
                            <option value="" disabled selected hidden>Selecciona el estado del artículo</option>
