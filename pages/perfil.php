...
<div class="container-fluid py-4">
    <div class="atenea-profile-shell">
        <div class="d-flex justify-content-end mb-3">
            <a href="dashboard_admin.php" class="btn btn-outline-dark btn-sm">
                <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Regresar
            </a>
        </div>

        <section class="atenea-profile-hero profile-hero" aria-label="Resumen del perfil administrativo">
            <div class="atenea-profile-hero__avatar" aria-hidden="true">
                <span><?php echo dashboard_h($initials ?: 'AD'); ?></span>
            </div>

            <div class="atenea-profile-hero__main profile-info">
                <div class="atenea-profile-hero__identity profile-identity">
                    <p class="atenea-profile-hero__kicker">Perfil de administrador</p>
            ...
            <div class="atenea-profile-hero__aside profile-side-cards" aria-label="Detalles del administrador">
                <div class="atenea-profile-hero__status profile-side-card">
                    ...
                    <div class="atenea-profile-side-card__content">
                        ...
                        <small>El acceso del administrador está habilitado para utilizar Atenea.</small>
                    </div>
                </div>
        ...
        <section class="atenea-profile-section atenea-profile-section--readonly">
            <div class="atenea-profile-section__header">
                ...
                <p>Consulta los datos principales del administrador y la información de contacto registrada en Atenea.</p>
            </div>
