...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    switch ($userType) {
        ...
        case 'SuperAdmin':
            ...
            break;
        default:
            $redirectUrl = "con_evaluacion.php"; // Redirigir a la página de inventario si el tipo no está definido
            break;
    }
...
$query = "SELECT c.contenido_id, c.titulo, c.descripcion, c.material, c.da_id, a.A_NAME, g.G_NAME, p.p_name, e.FIRST_NAME, e.LAST_NAME
          FROM contenidos c
...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        ...
        <a href="con_evaluacion.php" type="button" class="btn btn-primary bg-gradient-primary btn-block">
            <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Regresar
        </a>
        <div class="card-body">
            <form role="form" method="post" action="con_evaluacion_edit1.php" enctype="multipart/form-data">
