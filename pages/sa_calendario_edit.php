...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form role="form" id="editActivityForm">
            <input type="hidden" name="act_id" value="<?php echo $actividad['ACT_ID']; ?>">
            <div class="form-group">
                <input class="form-control" placeholder="Nombre de la actividad" minlength="5" maxlength="110" name="act_nombre" value="<?php echo $actividad['ACT_NOMBRE']; ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <select class="form-control" name="act_estado" required>
                    <option value="1" <?php echo $actividad['ACT_ESTADO'] == '1' ? 'selected' : ''; ?>>Activo</option>
                    <option value="0" <?php echo $actividad['ACT_ESTADO'] == '0' ? 'selected' : ''; ?>>Inactivo</option>
                </select>
            </div>
            <hr>
            <button type="submit" class="btn btn-success"><i class="fa fa-check fa-fw"></i> Guardar</button>
            <a href="sa_calendario.php" class="btn btn-primary"><i class="fas fa-flip-horizontal fa-fw fa-share"></i> Regresar</a>
        </form>  
    </div>
</div>
...
document.getElementById('editActivityForm').addEventListener('submit', function(e) {
    ...
    fetch('sa_calendario_edit1.php?action=update', {
        method: 'POST',
        body: formData
    })
        ...
        if (data.success === false) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'sa_calendario.php';
                }
            });
