...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT a_id, nombre_archivo, permisos, fecha_subida FROM archivos WHERE a_id = ? AND a_estado = 1";
...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        ...
        <div class="card-body">
            <form role="form" method="post" action="documentacion_edit1.php" enctype="multipart/form-data">
