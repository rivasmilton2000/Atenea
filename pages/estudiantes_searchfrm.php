...
$query = "SELECT e.nombres_estudiante, e.apellidos_estudiante, e.direccion_estudiante, e.correo_estudiante, e.fecha_nac_estudiante, e.edad_estudiante, e.genero_estudiante, g.G_NAME AS grado, e.carnet_estudiante, e.info_medica_estudiante, e.numero_lista_estudiante, e.fecha_reg_estudiante, e.foto_estudiante
FROM estudiantes e
