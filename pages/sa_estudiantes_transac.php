...
$query = "INSERT INTO estudiantes (nombres_estudiante, apellidos_estudiante, direccion_estudiante, correo_estudiante, fecha_nac_estudiante, edad_estudiante, genero_estudiante, grado_id_estudiante, carnet_estudiante, info_medica_estudiante, fecha_reg_estudiante, nombres_encargado, apellidos_encargado, dui_encargado, direccion_encargado, correo_encargado, trabajo_encargado, numero_cel_encargado, numero_tel_encargado, genero_encargado, fecha_nac_encargado, foto_estudiante, estado_estudiante) 
VALUES ('$nombres_estudiante', '$apellidos_estudiante', '$direccion_estudiante', '$correo_estudiante', '$fecha_nac_estudiante', '$edad_estudiante', '$genero_estudiante', '$grado_id_estudiante', '$carnet_estudiante', '$info_medica_estudiante', '$fecha_reg_estudiante', '$nombres_encargado', '$apellidos_encargado', '$dui_encargado', '$direccion_encargado', '$correo_encargado', '$trabajo_encargado', '$numero_cel_encargado', '$numero_tel_encargado', '$genero_encargado', '$fecha_nac_encargado', '$foto_estudiante', '$estado_estudiante')";
