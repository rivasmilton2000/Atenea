...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $query2 = 'SELECT e.EMPLOYEE_ID, e.FIRST_NAME, e.LAST_NAME, e.GENDER, e.EMAIL, e.PHONE_NUMBER, j.JOB_TITLE, e.HIRED_DATE, t.TYPE, l.PROVINCE, l.CITY, e.E_ESTADO
               FROM employee e
...
<!-- Resto del código HTML -->
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <a href="sa_personal.php" type="button" class="btn btn-primary bg-gradient-primary"><i class="fas fa-flip-horizontal fa-fw fa-share"></i>Regresar</a>
            <div class="card-body">
                    ...
                    <div class="form-group row text-left">
                      <div class="col-sm-3 text-primary">
                        <h5>Fecha de contratación<br></h5>
                      </div>
                      <div class="col-sm-9">
                ...
                <div class="col-sm-9">
                    <h5>
                        : <?php echo ($l == 1) ? '<span class="badge badge-success">Activo</span>' : '<span class="badge badge-danger">Inactivo</span>'; ?>
                    </h5>
                </div>
            </div>
