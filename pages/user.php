...
?>
        <!-- ADMIN TABLE -->
         <div class="card shadow mb-4">
           ...
           <table class="table table-bordered js-datatable" id="dataTableAdmins" width="100%" cellspacing="0">
               <thead>
                   <tr>
                ...
                <div class="btn-group">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu text-center" role="menu">
                            ...
                            <li>
                                <a type="button" class="btn btn-danger bg-gradient-danger btn-block" style="border-radius: 0px;" href="eliminar_usuario.php?id=' . $row['ID'] . '">
...
?>
         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <div class="table-responsive">
           <table class="table table-bordered js-datatable" id="dataTableEmployees" width="100%" cellspacing="0">
               <thead>
                   <tr>
                       <th>Nombre completo</th>
                       <th>Nombre de usuario</th>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Ingresar cuenta de usuario</h5>
        ...
        <div class="modal-body">
          <form role="form" method="post" action="us_transac.php?action=add">
              ...
              <div class="form-group">
                <input class="form-control" placeholder="Nombre de usuario" name="username" required>
              </div>
              <div class="form-group">
