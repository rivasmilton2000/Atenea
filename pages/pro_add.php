...
?>
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Ingresar a bodega</h4>
            </div>
            <a href="product.php?action=add" type="button" class="btn btn-primary bg-gradient-primary">Regresar</a>
            <div class="card-body">
                      <div class="table-responsive">
                        ...
                        <form role="form" method="post" action="pro_transac.php?action=add">
                            <div class="form-group">
                              <input class="form-control" placeholder="Código del producto" name="prodcode" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <input type="datet" class="form-control" placeholder="Fecha de entrada de existencias" name="datestock" required>
                            </div>
                            <hr>
