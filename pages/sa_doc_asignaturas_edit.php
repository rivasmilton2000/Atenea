...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        ...
        <a type="button" class="btn btn-primary bg-gradient-primary btn-block" href="sa_doc_asignaturas.php"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Regresar </a>
        <div class="card-body">
            <form role="form" method="post" action="sa_doc_asignaturas_edit1.php">
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="da_estado" required>
                            <option value="1" <?php if($da_estado == 1) echo 'selected'; ?>>Activo</option>
                            <option value="0" <?php if($da_estado == 0) echo 'selected'; ?>>Inactivo</option>
                        </select>
                    </div>
                </div>
                <hr>
