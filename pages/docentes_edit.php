...
while ($row = mysqli_fetch_array($result)) {
    ...
    $g = $row['PHONE_NUMBER'];
    $h = $row['JOB_TITLE'];
    $i = date("d-m-Y", strtotime($row['HIRED_DATE'])); // Formato dd-mm-yyyy
    $j = $row['PROVINCE'];
    $k = $row['CITY'];
    $l = $row['TYPE'];
...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            </div><a  type="button" class="btn btn-primary bg-gradient-primary btn-block" href="docentes.php?"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Regresar </a>
            <div class="card-body">
      

            <form role="form" method="post" action="docentes_edit1.php">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Nombres" name="firstname" minlength="5" maxlength="40" value="<?php echo $a; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Apellidos" name="lastname" minlength="5" maxlength="40" value="<?php echo $b; ?>" required>
                </div>
              </div>
