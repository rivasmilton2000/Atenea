...
$query = "SELECT ed.ed_id, e.nombres_estudiante, e.apellidos_estudiante, e.carnet_estudiante, e.numero_lista_estudiante, 
                 ...
                 da.da_id, p.p_id, e.ESTUDIANTE_ID, ed.periodo_id, da.grado_id
...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        ...
        <a type="button" class="btn btn-primary bg-gradient-primary btn-block" href="dis_asignaturas.php"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Regresar </a>
        <div class="card-body">
            <form role="form" method="post" action="dis_asignaturas_edit1.php">
...
<script>
  ...
  // Actualizar los campos de carnet y número de lista cuando se cambia el estudiante seleccionado
  document.getElementById('estudiante').addEventListener('change', function() {
    updateCarnetNumeroLista(this.value);
  });
</script>
