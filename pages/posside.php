<!-- SIDE PART NA SUMMARY -->
        <div class="card-body col-md-3 legacy-shell-summary">
        <?php   
                    ...
                    <div class="col-sm-12 mb-2">
                      <div class="input-group mb-2">
                        <div class="input-group-prepend">
                          ...
                          <input class="form-control text-right" id="txtNumber" onkeypress="return isNumberKey(event)" type="text" name="cash" placeholder="INGRESAR EFECTIVO" name="cash" required>
                    </div>
                  </div>
              </div>
