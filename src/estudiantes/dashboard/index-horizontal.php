      ...
      <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="container-fluid">
             ...
             <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link active" href="../dashboard/index-horizontal.php"> Horizontal </a></li>
                <li class="nav-item"><a class="nav-link " href="../dashboard/index-dual-horizontal.php"> Dual Horizontal </a></li>
                <li class="nav-item"><a class="nav-link " href="../dashboard/index-dual-compact.php"><span class="item-name">Dual Compact</span></a></li>
                <li class="nav-item"><a class="nav-link " href="../dashboard/index-boxed.php"> Boxed Horizontal </a></li>
                <li class="nav-item"><a class="nav-link " href="../dashboard/index-boxed-fancy.php"> Boxed Fancy</a></li>
             </ul>
          </div> <!-- container-fluid.// -->
          </nav>
