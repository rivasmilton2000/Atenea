    ...
    <main class="main-content">
      ...
      <div class="navbar dual-horizontal">
        ...
        <div class="container-fluid">
           ...
           <ul class="navbar-nav">
              <li class="nav-item"><a class="nav-link " href="../dashboard/index-horizontal.php"> Horizontal </a></li>
              <li class="nav-item"><a class="nav-link active" href="../dashboard/index-dual-horizontal.php"> Dual Horizontal </a></li>
