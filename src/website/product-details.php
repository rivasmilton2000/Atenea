...
<main class="main">
  ...
  <section class="product-detail section"><div class="container"><div class="row gy-5 gx-lg-5 align-items-start">
    ...
    <div class="col-lg-5"><article class="product-purchase-card">
      ...
      <?php if (!$agotado): ?><form class="product-checkout-form" method="post" action="<?= atenea_url('src/carrito/accion.php') ?>" data-checkout-form>
        <input type="hidden" name="csrf_token" value="<?= atenea_e(obtenerTokenCsrf()) ?>"><input type="hidden" name="accion" value="agregar"><input type="hidden" name="producto_id" value="<?= $id ?>">
