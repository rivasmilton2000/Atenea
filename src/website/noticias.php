...
?>
<main class="main">
  <section class="page-title light-background"><div class="container"><nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?=atenea_url('index.php')?>">Inicio</a></li><li class="breadcrumb-item active" aria-current="page">Noticias</li></ol></nav><h1><?=atenea_e((string)($seccionNoticias['titulo']??'Noticias'))?></h1><?php if(!empty($seccionNoticias['subtitulo'])):?><p><?=atenea_e((string)$seccionNoticias['subtitulo'])?></p><?php endif;?></div></section>
