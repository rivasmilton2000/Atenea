...
exigirAutenticacion();
if(esRolAdministradorDocenteAtenea($_SESSION['usuario_rol']??null)){if(modoHibridoActualAtenea()==='admin')exigirPermiso('notifications.view');else{exigirModoHibridoAtenea('docente');exigirPermiso('academic.notifications.view');}}
