<?php require_once __DIR__ . '/../../_auth_guard.php'; require_once dirname(__DIR__, 4) . '/includes/alerts.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <?php $dashboardActive = 'legacy'; require __DIR__ . '/../../partials/_sidebar.php'; ?>
        <!-- partial -->
