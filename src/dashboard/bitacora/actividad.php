...
if(esRolAdministradorDocenteAtenea($_SESSION['usuario_rol']??null)&&$usuarioId!==(int)$_SESSION['usuario_id']){registrarFalloGlobalAtenea('Bitácora híbrida fuera de alcance.',403);mostrarPaginaErrorAtenea(403);}
$pdo=obtenerConexion();
