...
<nav class="sidebar sidebar-offcanvas" id="sidebar" data-active-managed="server" aria-label="Navegación administrativa">
  <ul class="nav">
    ...
    <li class="nav-item <?= $operacionesAbiertas ? 'active' : '' ?>">
      ...
      <div class="collapse <?= $operacionesAbiertas?'show':'' ?>" id="menu-operaciones" data-bs-parent="#sidebar"><ul class="nav flex-column sub-menu"><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/notificaciones/index.php')?>">Notificaciones</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/comunicaciones/agenda.php')?>">Agenda</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/comunicaciones/chat.php')?>">Chat interno</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/comunicaciones/correo.php?vista=entrada')?>">Centro de correo</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/comunicaciones/servicio.php')?>">Estado del servicio</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/comunicaciones/moderacion.php')?>">Moderación</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/comunicaciones/index.php')?>">Historial heredado</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/errores/index.php')?>">Errores operativos</a></li></ul></div>
    </li>
