...
$operacionesAbiertas = str_starts_with($dashboardActive,'notificaciones/') || str_starts_with($dashboardActive,'comunicaciones/') || str_starts_with($dashboardActive,'newsletter/') || str_starts_with($dashboardActive,'errores/');
...
$rolUsuarios = in_array((string) ($_GET['rol'] ?? ''), rolesAdministrablesAtenea(), true) ? (string) $_GET['rol'] : '';
?>
<nav class="sidebar sidebar-offcanvas" id="sidebar" data-active-managed="server" aria-label="Navegación administrativa">
  <ul class="nav">
    ...
    <li class="nav-item <?= $operacionesAbiertas ? 'active' : '' ?>">
      ...
      <div class="collapse <?= $operacionesAbiertas?'show':'' ?>" id="menu-operaciones" data-bs-parent="#sidebar"><ul class="nav flex-column sub-menu"><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/notificaciones/index.php')?>">Notificaciones</a></li><?php if(usuarioTienePermiso('newsletter.view')):?><li class="nav-item"><a class="nav-link <?=str_starts_with($dashboardActive,'newsletter/')?'active':''?>" href="<?=atenea_url('src/dashboard/newsletter/index.php')?>">Boletín y campañas</a></li><?php endif;?><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/comunicaciones/agenda.php')?>">Agenda</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/comunicaciones/chat.php')?>">Chat interno</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/comunicaciones/correo.php?vista=entrada')?>">Centro de correo</a></li><li class="nav-item"><a class="nav-link <?= $dashboardActive==='comunicaciones/correos.php'?'active':'' ?>" href="<?=atenea_url('src/dashboard/comunicaciones/correos.php')?>">Cola e historial de correos</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/comunicaciones/servicio.php')?>">Estado del servicio</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/comunicaciones/moderacion.php')?>">Moderación</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/comunicaciones/index.php')?>">Historial heredado</a></li><li class="nav-item"><a class="nav-link" href="<?=atenea_url('src/dashboard/errores/index.php')?>">Errores operativos</a></li></ul></div>
    </li>
    <li class="nav-item nav-category">Gestión de usuarios</li>
    <li class="nav-item <?= $academicoActivo ? 'active' : '' ?>"><a class="nav-link <?= $academicoActivo ? '' : 'collapsed' ?>" data-bs-toggle="collapse" href="#menu-academico" aria-expanded="<?= $academicoActivo ? 'true' : 'false' ?>"><i class="menu-icon mdi mdi-school-outline"></i><span class="menu-title">Gestión académica</span><i class="menu-arrow"></i></a><div class="collapse <?= $academicoActivo ? 'show' : '' ?>" id="menu-academico" data-bs-parent="#sidebar"><ul class="nav flex-column sub-menu"><li class="nav-item"><a class="nav-link <?= str_starts_with($dashboardActive,'capacitaciones/')?'active':'' ?>" href="<?=atenea_url('src/dashboard/capacitaciones/index.php')?>">Capacitaciones</a></li><li class="nav-item"><a class="nav-link <?= $dashboardActive==='academico/seguimiento.php'?'active':'' ?>" href="<?=atenea_url('src/dashboard/academico/seguimiento.php')?>">Seguimiento y certificados</a></li><li class="nav-item"><a class="nav-link <?= $dashboardActive==='academico/index.php'?'active':'' ?>" href="<?=atenea_url('src/dashboard/academico/index.php')?>">Académico heredado</a></li></ul></div></li>
    <li class="nav-item <?= $usuariosAbierto ? 'active' : '' ?>">
      ...
      <div class="collapse <?= $usuariosAbierto ? 'show' : '' ?>" id="menu-usuarios" data-bs-parent="#sidebar"><ul class="nav flex-column sub-menu">
        ...
        <li class="nav-item"><a class="nav-link <?= $usuariosAbierto && $rolUsuarios === 'administrador_docente' ? 'active' : '' ?>" href="<?= atenea_url('src/dashboard/usuarios/index.php?rol=administrador_docente') ?>">Administradores docentes</a></li>
