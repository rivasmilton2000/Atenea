...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item <?= $inicioAbierto ? 'active' : '' ?>">
      <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="<?= $inicioAbierto ? 'true' : 'false' ?>" aria-controls="ui-basic">
        <i class="menu-icon mdi mdi-floor-plan"></i>
        <span class="menu-title">Pagina de inicio</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse <?= $inicioAbierto ? 'show' : '' ?>" id="ui-basic">
    ...
    <li class="nav-item <?= $configAbierta ? 'active' : '' ?>">
      <a class="nav-link" data-bs-toggle="collapse" href="#form-elements" aria-expanded="<?= $configAbierta ? 'true' : 'false' ?>" aria-controls="form-elements">
        <i class="menu-icon mdi mdi-card-text-outline"></i>
        <span class="menu-title">Configuracion</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse <?= $configAbierta ? 'show' : '' ?>" id="form-elements">
        <ul class="nav flex-column sub-menu">
    ...
    <li class="nav-item <?= $dashboardActive === 'portal-estudiante' ? 'active' : '' ?>">
      <a class="nav-link" data-bs-toggle="collapse" href="#charts" aria-expanded="<?= $dashboardActive === 'portal-estudiante' ? 'true' : 'false' ?>" aria-controls="charts">
        <i class="menu-icon mdi mdi-chart-line"></i>
        <span class="menu-title">Portal estudiante</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse <?= $dashboardActive === 'portal-estudiante' ? 'show' : '' ?>" id="charts">
        <ul class="nav flex-column sub-menu">
