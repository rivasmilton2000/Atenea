...
</div></div></div></div></div><div class="col-md-6 d-md-block d-none bg-primary p-0 vh-100 overflow-hidden"><img src="<?= atenea_url(obtenerConfiguracionPortalEstudiante('login_imagen_lateral')) ?>" class="img-fluid gradient-main animated-scaleX" alt="Seguridad de la cuenta Atenea"></div></div></section></div><script src="<?= atenea_url('src/estudiantes/assets/js/core/libs.min.js') ?>"></script></body></html>
