...
</div></div></div></div></div><div class="col-md-6 d-md-block d-none bg-primary p-0 vh-100 overflow-hidden"><img src="<?= recursoPortalEstudiante('login_imagen_lateral','src/estudiantes/dashboard_estudiantes/dashboard/assets/images/dashboard/darkBG.png') ?>" class="img-fluid gradient-main animated-scaleX" alt="Seguridad de la cuenta Atenea"></div></div></section></div><script src="<?= atenea_url('src/estudiantes/dashboard_estudiantes/dashboard/assets/vendors/js/vendor.bundle.base.js') ?>"></script><script src="<?=atenea_url('src/website/assets/js/security-ui.js')?>"></script><?php ateneaAlertasScripts($errores ? ['type' => 'error', 'title' => 'Revisa la nueva contraseña', 'message' => implode("\n", array_map('strval', $errores))] : null); ?></body></html>
